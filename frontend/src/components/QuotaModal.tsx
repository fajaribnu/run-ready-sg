              ...
              >
                ...
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-500/10 ring-1 ring-blue-500/20">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className="text-blue-400">
                    <path d="M12 8v4m0 4h.01M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9 9 4.03 9 9z" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
                  </svg>
                </div>

                <h2 className="mb-2 text-xl font-semibold tracking-tight text-white">Daily limit reached</h2>

                <p className="mb-6 text-sm leading-relaxed text-white/55">
                  You've used your <span className="text-white/80">3 free checks</span> for today.{" "}
                  {SHOW_PRO_TIER
                ...
                {SHOW_PRO_TIER && (
                  <div className="mb-6 grid grid-cols-2 gap-3">
                    <div className="rounded-xl border border-white/8 bg-white/4 p-4">
                      <p className="mb-1 text-xs font-medium uppercase tracking-widest text-white/40">Free</p>
                      <p className="text-2xl font-bold text-white">10<span className="ml-1 text-sm font-normal text-white/50">/ day</span></p>
                    ...
                    <div className="relative overflow-hidden rounded-xl border border-blue-500/30 bg-blue-500/8 p-4">
                      ...
                      <p className="mb-1 text-xs font-medium uppercase tracking-widest text-blue-400">Pro</p>
                      <p className="text-2xl font-bold text-white">∞<span className="ml-1 text-sm font-normal text-white/50">/ day</span></p>
                      <p className="mt-1 text-xs text-blue-400/70">Unlimited</p>
                    </div>
                  </div>
                )}

                {!SHOW_PRO_TIER && <div className="mb-6 h-px w-full bg-white/8" />}
        ...
        {showPending && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 z-50 flex items-center justify-center p-4"
            >
              <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-[#0f1117] p-8 shadow-2xl text-center">
                <button
                  onClick={() => setShowPending(false)}
                  className="absolute right-4 top-4 rounded-full p-1 text-white/40 transition hover:text-white/80"
                >
                ...
                <div className="mb-5 mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-blue-500/10 ring-1 ring-blue-500/20">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className="text-blue-400">
                ...
                <h2 className="mb-2 text-xl font-semibold tracking-tight text-white">Coming soon</h2>
                <p className="mb-6 text-sm leading-relaxed text-white/55">
                  Pending feature - come back later for more awesome features!
                </p>
