...
export default function useLeafletMap({
  ...
  /* =====================================================
   * ROUTE DRAW — all 3 backend-colored routes
   * Dimmed routes use backend color at low opacity.
   * Selected route is animated at full opacity.
   * During navigation only the selected route is shown.
   * ===================================================*/
  useEffect(() => {
    const map = mapRef.current;
